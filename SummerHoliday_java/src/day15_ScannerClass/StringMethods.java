...
public class StringMethods {
	 ...
	 * 			indexOf()	==> it turns the first index of the char in the string
	 * 			concat() ==> it takes the string and concatenate it the string that you written between the parentheses
	...
	public static void main(String[] args) {
		...
		char ch = word.charAt(1);// usage of charAt() method
			System.out.println(ch);
		int num =  word.length();// usage of lenght () method
			System.out.println(num);
		String wordConcat = word.concat(" selcuk");// word will not be changed there will be created a brand new string
												// and you can assign this new string to any string what ever you want.
			System.out.println(wordConcat);
		int num2 = word.indexOf('r');
			System.out.println(num2);		// it turns the first index of the char
		String UpperCase = word.toUpperCase();// it creates a new string by all upper case
